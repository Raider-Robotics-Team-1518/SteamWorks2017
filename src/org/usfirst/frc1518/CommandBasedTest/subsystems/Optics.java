...
public class Optics extends Subsystem {
	...
	protected void initDefaultCommand() {
		...
		/*
		 * String targetDistance = "Distance: " + Robot.leftButtCheek; origin =
		 * new Point(0,0); textColor = new RGBValue(255,255,255,255); if
		 * (Robot.camSelect2 == false) { RobotMap.axisCam1.getImage(frame); }
		 * else { RobotMap.axisCam1.getImage(frame); }
		 * //NIVision.imaqOverlayText(frame, origin, targetDistance, textColor,
		 * null, "");
		 */
