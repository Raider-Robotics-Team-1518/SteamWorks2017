...
public static JoystickButton retractServo;
...
public static JoystickButton unstick;
    ...
    public OI() {
    	...
    	trigger = new JoystickButton(mainstick, 2);
    	...
    	reverseDrive = new JoystickButton(mainstick, 8);
    	reverseDrive.whenPressed(new ReverseDrive());
    	intake = new JoystickButton(mainstick, 7);
    	intake.whileHeld(new Feed());
    	lift = new JoystickButton(mainstick, 1);
    	lift.whileHeld(new Lift());
    	unstick = new JoystickButton(mainstick, 4);
    	//rabbitIntake = new JoystickButton(mainstick, 4);
    	//rabbitIntake.whileHeld(new RIntake());
    	//retractServo = new JoystickButton(mainstick, 3);
    	//retractServo.whenPressed(new RetractServo());
