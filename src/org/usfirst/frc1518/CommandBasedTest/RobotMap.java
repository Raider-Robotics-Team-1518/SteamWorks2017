...
public class RobotMap {
    ...
    public static void init() {
    	...
    	feedMotor = new CANTalon(7);
    	//TODO: Find out which CAN ID feedMotor1 has on the real robot once they have power to it.
    	...
    	driveTrainFrontLeftWheel.enableBrakeMode(true);
    	driveTrainFrontRightWheel.enableBrakeMode(true);
    	driveTrainRearLeftWheel.enableBrakeMode(true);
    	driveTrainRearRightWheel.enableBrakeMode(true);
    	//Encoders
    	driveTrainFrontLeftWheel.setFeedbackDevice(FeedbackDevice.QuadEncoder);
		driveTrainFrontRightWheel.setFeedbackDevice(FeedbackDevice.QuadEncoder);
		driveTrainFrontRightWheel.reverseSensor(true);
		//Gyro 
